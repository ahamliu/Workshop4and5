...
export default class FeedItem extends React.Component {
  ...
  return (
    <Comment key={i} author={comment.author} postDate={comment.postDate} likeCounter={comment.likeCounter} feedItemId={this.props.id} index={i}>{comment.contents}</Comment>
  );
}) }
        </CommentThread>
      </div>
